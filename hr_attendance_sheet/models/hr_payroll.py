...
class HrPayslip(models.Model):
    ...
    unattended_days = fields.Integer(string="Number of Unttended Days", compute="_compute_att_sheet_data", readonly=True,
                                      store=True)
    attendance_count = fields.Integer(string="Number of Attended Days", compute="_compute_att_sheet_data", readonly=True,
                                      store=True)
